      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Center(child: Image.asset('assets/kutubdia.jpeg',fit: BoxFit.cover,)),
              const SizedBox(
                height: 4,
              ),
              const Text(
              ...
              const Text('কক্সবাজার থেকে কুতুবদিয়া দুরত্ব  -৯০ কিঃ মিঃ (প্রায়)',style: TextStyle(fontWeight: FontWeight.bold),),
              const Text('চট্টগ্রাম থেকে কুতুবদিয়ার  দুরত্ব  -১১৫ কি:মি: (প্রায়)',style: TextStyle(fontWeight: FontWeight.bold),),
              const Text('প্রধান পেশা  -কৃষি, লবণ, মৎস্য।',style: TextStyle(fontWeight: FontWeight.bold),),
              const SizedBox(
                height: 4,
              ),
              const Text(
              ...
              const Text(' > কুতুবউদ্দিন (রহ.) [যার নামে কুতুবদিয়া দ্বীপের নামকরণ]'),
              const SizedBox(
                height: 4,
              ),
